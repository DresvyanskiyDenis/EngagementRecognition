...
def load_data(scaler: str):
    ...
    train_3 = pd.read_csv(
        "/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/EmoVGGFace2/train_extracted_deep_embeddings.csv")
    ...
    dev_3 = pd.read_csv(
        "/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/EmoVGGFace2/dev_extracted_deep_embeddings.csv")
