...
def run(scaler):
    print("New start...!!! With emotional embeddings")
    sweep_config = {
        'name': "Direct_fusion_f2f_%sScaler_focal_loss(facial, pose, emotional)"%scaler,
        'method': 'random',
        'metric': {
            'name': 'val_loss',
            'goal': 'minimize'
    ...
    train_2 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/Xception_model/train_extracted_deep_embeddings.csv")
    train_3 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/EmoVGGFace2/train_extracted_deep_embeddings.csv")
    ...
    dev_2 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/Xception_model/dev_extracted_deep_embeddings.csv")
    dev_3 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/EmoVGGFace2/dev_extracted_deep_embeddings.csv")
    ...
    if scaler == "PCA":
        ...
        PCA_components = None
    # create generators
    train_generator = FusionDataLoader([train_1, train_2, train_3], scaling=scaler, PCA_components=PCA_components, labels_included=True)
    dev_generator = FusionDataLoader([dev_1, dev_2, dev_3], scaling=train_generator.scaler, PCA_components=PCA_components, labels_included=True)
