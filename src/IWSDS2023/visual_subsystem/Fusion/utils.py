...
if __name__=="__main__":
    train_1 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/Pose_model/embeddings_dev.csv")
    train_1 = cut_filenames_to_original_names(train_1)
    train_2 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/Xception_model/dev_extracted_deep_embeddings.csv")
    train_2 = cut_filenames_to_original_names(train_2)
    train_3 = pd.read_csv("/work/home/dsu/IWSDS2023/NoXi_embeddings/All_languages/EmoVGGFace2//dev_extracted_deep_embeddings.csv")
