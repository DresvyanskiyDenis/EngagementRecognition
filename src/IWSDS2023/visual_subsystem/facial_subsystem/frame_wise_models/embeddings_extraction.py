#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Contains the script for extracting the embeddings from the facial images taken from IWSDS2023 dataset.
...
def extract_embeddings(language:str, model_weights:str):
    ...
    output_dir="/work/home/dsu/IWSDS2023/NoXi_embeddings/Cross-corpus/"+language.capitalize()+"/EmoVGGFace2/"
