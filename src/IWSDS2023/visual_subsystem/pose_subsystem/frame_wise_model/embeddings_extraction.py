...
from src.IWSDS2023.visual_subsystem.pose_subsystem.frame_wise_model.utils import convert_image_to_float_and_scale, \
...
def main():
    ...
    output_path = "/work/home/dsu/IWSDS2023/NoXi_embeddings/Cross-corpus/%s/pose_model/"%(language.capitalize())
