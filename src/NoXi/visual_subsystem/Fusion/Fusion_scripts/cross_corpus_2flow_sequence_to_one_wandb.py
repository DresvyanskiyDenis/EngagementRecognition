...
def load_data_cross_corpus(language:str, window_length:int, window_shift:int):
    # load train data
...
def run(window_length:int, language:str):
    print("New start...!!!")
    sweep_config = {
        'name': "Cross_corp_2Flow_fusion_Seq2One_Standard_scaler_%s_window_%i" % (language, window_length),
        'method': 'random',
        'metric': {
            'name': 'val_loss',
            'goal': 'minimize'
